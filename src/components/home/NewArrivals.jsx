        ...
        <div className="mb-[118px]">
            ...
            <div className="relative ">
              ...
              > 
                ...
                <button className='arrow-right p-5 bg-slate-400 border rounded-full absolute top-1/2 -translate-y-1/2 left-0 z-10'>
                ...
                <button className='arrow-left p-5 bg-slate-400 border rounded-full absolute top-1/2 -translate-y-1/2 right-0 z-10'>
                  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 16 8" fill="none">
